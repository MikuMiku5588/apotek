  ...
  <body class="bg-white text-slate-800">
    <header class="bg-red-600">
      <div class="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div class="flex items-center gap-2">
          ...
          <a href="<?php echo e(route('cart')); ?>" class="text-white transition-transform active:scale-95" aria-label="Keranjang">
    ...
    <main class="max-w-md mx-auto px-4 py-6 space-y-4">
      ...
      <div class="pt-2 grid grid-cols-2 gap-3">
        <a href="<?php echo e(route('pay')); ?>?n=Brufen%20100mg%20%2F%205ml%20Syrup&p=3000&q=1" class="block w-full">
    ...
    <script>
      ...
      addCartBtn?.addEventListener('click', () => {
        ...
        write(arr)
        const cartUrl = "<?php echo e(route('cart')); ?>"
        window.location.href = cartUrl
      })
    </script>
  </body>
  </html>
<?php /**PATH C:\Users\MyBook Hype\Documents\projeks\laravel12_breeze\resources\views/product.blade.php ENDPATH**/ ?>
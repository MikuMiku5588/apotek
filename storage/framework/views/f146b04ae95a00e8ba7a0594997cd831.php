          ...
          <div class="flex items-center gap-4">
            <div class="relative">
              ...
              <div id="menuPopover" class="hidden absolute right-0 mt-2 w-44 sm:w-52 bg-white rounded-2xl shadow-lg ring-1 ring-slate-200 p-3">
                <a href="<?php echo e(route('login.ui')); ?>" class="block">
            ...
            <a href="<?php echo e(route('cart')); ?>" class="flex items-center text-white transition-transform active:scale-95" aria-label="Keranjang">
    ...
    <script>
      ...
      document.querySelectorAll('button[data-item]').forEach(btn => {
        btn.addEventListener('click', () => {
          const productUrl = "<?php echo e(route('product')); ?>"
...
<?php /**PATH C:\Users\MyBook Hype\Documents\projeks\laravel12_breeze\resources\views/index.blade.php ENDPATH**/ ?>
...
@section('content')
  ...
  <script>
    ...
    buyBtn?.addEventListener('click', () => {
      ...
      let target = '{{ url('/receipt') }}'
      if (selectedMethod === 'qris') target = '{{ url('/pay/qris') }}'
      else if (selectedMethod.startsWith('ewallet:')) target = '{{ url('/pay/ewallet') }}'
      else if (selectedMethod.startsWith('bank:')) target = '{{ url('/pay/bank') }}'

        ...
        <div class="max-w-7xl mx-auto flex items-center justify-between px-4 py-3">
          ...
          <div class="relative">
            ...
            <div id="adminMenuPopover" class="hidden absolute right-0 mt-2 w-44 bg-white rounded-2xl shadow-lg ring-1 ring-slate-200 p-3">
              <a href="{{ route('input') }}" class="block">
      ...
      <section>
        <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div class="bg-white rounded-2xl shadow-sm ring-1 ring-slate-200 p-4 flex flex-col h-full">
            ...
            <a href="{{ route('edit') }}" aria-label="Edit" class="mt-auto w-full flex items-center justify-center gap-2 bg-red-600 text-white rounded-full py-2 transition-transform duration-200 active:scale-95 hover:shadow-md">
